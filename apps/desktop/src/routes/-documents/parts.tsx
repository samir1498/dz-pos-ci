 ...
 *
 * **The figure.** Neither dialog works out what leaves the drawer. That
 * subtraction is `services::cancellation::cash_going_back`, and its own doc
 * says why a facture's cannot be read off its own totals: an avoir already
 * written against it lowers what is left. So this shows the two stored
 * figures the rule is written on — what the customer handed over, and the
 * droit de timbre inside it that never comes back (features.md §1, "Cash
 * handed back") — and says that the exact amount is the core's.
 */
