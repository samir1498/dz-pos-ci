...
function Sidebar({
  ...
  // Every visible string, the off-screen ones included, goes through i18n
  // (context/processes/coding-rules). shadcn ships these three in English.
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      {...props}
    >
      {/* The panel it opens is on the reading side, so the glyph points
          that way too. */}
