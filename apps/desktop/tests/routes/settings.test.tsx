...
import { SettingsLayout } from "../../src/routes/settings";
import { BackupsRoom } from "../../src/routes/settings.backups";
import { DataRoom } from "../../src/routes/settings.data";
import { RegimeRoom } from "../../src/routes/settings.regime";
import { ShopRoom } from "../../src/routes/settings.shop";
import { PrintingRoom } from "../../src/routes/settings.printing";
