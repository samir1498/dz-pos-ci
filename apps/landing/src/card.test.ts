...
// (DZPOS_CARD_WRITE=1 vitest run src/card.test.ts) writes public/og/card.png
...
//
// The same shape as src/shots.test.ts.
...
import { buildCard, CARD_FILE, CARD_HEIGHT, CARD_WIDTH } from "./lib/card";
