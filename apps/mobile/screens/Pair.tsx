...
//
// Shared across both router roots (C7): `app/pair.tsx` and
// `app-clinic/pair.tsx` both re-export this file unchanged, because pairing
// and the phone it hands off to (`/sign-in`, shared too) are the same for
// every trade.
