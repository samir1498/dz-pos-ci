...
//
// It lives under `tests/lib/` because that is what `vitest.config.ts`
// collects, and it reads the screens rather than rendering them, so it
// costs no test renderer and no jsdom.
//
