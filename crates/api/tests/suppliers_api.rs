...
// S7 of `a-kernel-crate-and-retail-as-the-first-module`: suppliers and their
// ledger are all retail (`routes::mod.rs`), so this whole file has nothing
// to compile with the feature off.
#![cfg(feature = "retail")]
