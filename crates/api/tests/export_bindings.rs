...
use dzpos_api::dto::{
    ...
    DashboardSeriesPointDto, DatedRegimeDto, DebtEntryDto, DebtKindDto, DocumentKindDto,
    ...
    SaleWarningDto, SessionDto, SessionIdleDto, SettingsDto, StockDriftDto, StockRecountDto,
    ...
    ThemeDto, TopProductDto, UnitDto,
};
use ts_rs::{Config, TS};
