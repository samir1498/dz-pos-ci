...
use dzpos_retail::money::{compute_totals, Bps, Line, Money, PaymentMode, Regime, TotalsOptions};
...
fn format_amount(amount: Money) -> String {
    dzpos_retail::money::format::format_centimes(amount)
}
...
fn a_refused_ticket_writes_no_file_and_opens_no_connection() {
    ...
    doc.totals.tva_by_rate.push(dzpos_retail::money::TvaLine {
