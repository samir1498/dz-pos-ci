...
use dzpos_retail::services::documents::DocumentStatus;
use dzpos_retail::services::shifts::{NewShift, TillCount};
use dzpos_retail::services::{cancellation, cash, debt, documents, shifts};
...
fn a_second_refund_against_one_document_is_refused_on_the_field() {
    ...
    let err = dzpos_retail::services::cash_refunds::hand_over(
        &mut conn,
        SHOP,
        OWNER,
        first.id,
