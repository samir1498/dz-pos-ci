...
fn the_invariants_the_rest_of_the_suite_holds_over_a_shop_hold_over_the_seeded_one() {
    ...
    for entry in dzpos_core::services::customers::list_with_balance(&mut conn, SHOP, None).unwrap()
    {
        assert_eq!(
            entry.balance,
    ...
    for kind in [
        dzpos_core::models::sql_types::DocumentKind::Ticket,
        dzpos_core::models::sql_types::DocumentKind::Facture,
        dzpos_core::models::sql_types::DocumentKind::Avoir,
    ] {
