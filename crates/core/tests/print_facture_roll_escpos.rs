...
use dzpos_core::services::documents::{DocumentKind, PartyKind};
                ...
                assert!(
                    carries(text(
                        match doc.payment_mode {
                            dzpos_core::money::PaymentMode::Cash => Key::Cash,
                            dzpos_core::money::PaymentMode::Card => Key::Card,
                            dzpos_core::money::PaymentMode::Credit => Key::Credit,
                        },
                        lang
                    )),
...
fn the_escpos_roll_refuses_what_the_sheet_refuses() {
    ...
    ifu.doc.totals.tva_by_rate.push(dzpos_core::money::TvaLine {
        rate: dzpos_core::money::Bps::new(1900).unwrap(),
