...
against a facture that is paid for, or a cancelled cash sale, which is where
an anonymous customer's refund lands because there is no ledger to credit. A
reversal settled on the ledger moves no notes and appears here as nothing.
