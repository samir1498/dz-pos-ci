...
export const PRODUCTS = [
  { id: 1, name: "Huile Elio 5L", ar: "زيت إليو 5ل", barcode: "6130001000018", cat: "epicerie", cost: c(820), price: c(920), tva: 19, qty: 24, min: 10 },
  { id: 2, name: "Sucre Cristal 1kg", ar: "سكر 1كغ", barcode: "6130001000025", cat: "epicerie", cost: c(95), price: c(110), tva: 9, qty: 60, min: 20 },
  { id: 3, name: "Farine Sim 1kg", ar: "فرينة سيم 1كغ", barcode: "6130001000032", cat: "epicerie", cost: c(58), price: c(70), tva: 9, qty: 8, min: 15 },
  { id: 4, name: "Couscous Moyen 1kg", ar: "كسكس متوسط 1كغ", barcode: "6130001000049", cat: "epicerie", cost: c(120), price: c(140), tva: 9, qty: 30, min: 10 },
  { id: 5, name: "Pâtes Spaghetti 500g", ar: "معكرونة 500غ", barcode: "6130001000056", cat: "epicerie", cost: c(62), price: c(75), tva: 9, qty: 45, min: 15 },
  { id: 6, name: "Tomate concentrée 400g", ar: "طماطم مركزة 400غ", barcode: "6130001000063", cat: "epicerie", cost: c(115), price: c(135), tva: 19, qty: 0, min: 12 },
  { id: 7, name: "Eau Ifri 1.5L", ar: "ماء إفري 1.5ل", barcode: "6130002000017", cat: "boissons", cost: c(30), price: c(40), tva: 19, qty: 120, min: 24 },
  { id: 8, name: "Hamoud Boualem 1L", ar: "حمود بوعلام 1ل", barcode: "6130002000024", cat: "boissons", cost: c(80), price: c(100), tva: 19, qty: 36, min: 12 },
  { id: 9, name: "Jus Ramy Orange 1L", ar: "عصير رامي برتقال 1ل", barcode: "6130002000031", cat: "boissons", cost: c(120), price: c(150), tva: 19, qty: 18, min: 12 },
  { id: 10, name: "Lait Candia 1L", ar: "حليب كانديا 1ل", barcode: "6130003000016", cat: "laitier", cost: c(115), price: c(130), tva: 9, qty: 40, min: 20 },
  { id: 11, name: "Yaourt Soummam x4", ar: "ياغورت صومام ×4", barcode: "6130003000023", cat: "laitier", cost: c(140), price: c(170), tva: 9, qty: 22, min: 10 },
  { id: 12, name: "Fromage La Vache 8p", ar: "جبن البقرة 8ق", barcode: "6130003000030", cat: "laitier", cost: c(250), price: c(290), tva: 19, qty: 14, min: 8 },
  { id: 13, name: "Savon Le Chat 4x", ar: "صابون لوشا ×4", barcode: "6130004000015", cat: "hygiene", cost: c(280), price: c(340), tva: 19, qty: 9, min: 10 },
  { id: 14, name: "Dentifrice Signal", ar: "معجون أسنان سيغنال", barcode: "6130004000022", cat: "hygiene", cost: c(190), price: c(240), tva: 19, qty: 25, min: 8 },
  { id: 15, name: "Isis Détergent 3kg", ar: "إيزيس منظف 3كغ", barcode: "6130005000014", cat: "menage", cost: c(690), price: c(790), tva: 19, qty: 11, min: 6 },
  { id: 16, name: "Eau de Javel 1L", ar: "ماء جافيل 1ل", barcode: "6130005000021", cat: "menage", cost: c(55), price: c(70), tva: 19, qty: 33, min: 10 },
];
