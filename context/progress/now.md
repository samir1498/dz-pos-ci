...
1. [ ] Read Code du timbre art. 100 + 258 ff. and CTCA art. 21/23/80bis from the PDFs on disk; write `research/legal-fiscal/droit-de-timbre.md` and `tva-and-rounding.md`; spec the `stamp_progressive_tranches` fixture (plan R1, R2)
